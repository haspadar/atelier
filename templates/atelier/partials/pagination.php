<nav aria-label="Pagination">
    <ul class="pagination">
        ...
        <span class="text-muted p-2">из <?=$this->data['pages_count']?> <span class="small">(всего <?=$this->data['count']?> <?=\Atelier\Plural::get($this->data['count'], 'строка', 'строки', 'строк')?>)</span></span>
    </ul>
</nav>